...
<section class="py-5 header">
    <div class="container py-4">
        <div class="row">
            <div class="col-md-3">
                <!-- Tabs nav -->
                <div class="nav flex-column nav-pills nav-pills-custom" id="v-darat" role="tablist" aria-orientation="vertical">
                    <a class="nav-link mb-3 p-3 shadow active" id="v-darat-tab" data-toggle="pill" href="#v-darat" role="tab" aria-controls="v-darat" aria-selected="true">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Ekspedisi Darat</span></a>
                    <a class="nav-link mb-3 p-3 shadow" id="v-laut-tab" data-toggle="pill" href="#v-laut" role="tab" aria-controls="v-laut" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Eskpedisi Laut</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-truck-tab" data-toggle="pill" href="#v-truck" role="tab" aria-controls="v-truck" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Charter Truck</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-container-tab" data-toggle="pill" href="#v-container" role="tab" aria-controls="v-container" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
