...
<section class="py-5 header">
    <div class="container py-4">
        <div class="row">
            <div class="col-md-3">
                <!-- Tabs nav -->
                <div class="nav flex-column nav-pills nav-pills-custom" id="v-tentang" role="tablist" aria-orientation="vertical">
                    <a class="nav-link mb-3 p-3 shadow active" id="v-tentang-tab" data-toggle="pill" href="#v-tentang" role="tab" aria-controls="v-darat" aria-selected="true">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Tentang Kayu Gaharu</span></a>
                    <a class="nav-link mb-3 p-3 shadow" id="v-fakta-tab" data-toggle="pill" href="#v-fakta" role="tab" aria-controls="v-fakta" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Fakta Kayu Gaharu</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-manfaat-tab" data-toggle="pill" href="#v-manfaat" role="tab" aria-controls="v-manfaat" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Manfaat Kayu Gaharu</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-ciri-tab" data-toggle="pill" href="#v-ciri" role="tab" aria-controls="v-ciri" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Ciri-ciri Kayu Gaharu</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-guna-tab" data-toggle="pill" href="#v-guna" role="tab" aria-controls="v-guna" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Kegunaan Kayu Gaharu</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-jenis-tab" data-toggle="pill" href="#v-jenis" role="tab" aria-controls="v-container" aria-selected="false">
                        <i class="fa fa-chevron-right mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">Jenis Kayu Gaharu</span></a>
                </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                              <div class="text__block mb-40">
                                <h5 class="text__block-title"><br>Tentang Kayu Gaharu</h5>
