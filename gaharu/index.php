...
<body class="bg-home6">
    ...
    <header class="header header--six">
        <div class="container">
            <div class="area">
                <div class="logo">
                    <a href="index.html">Kayu Gaharu</a>
                </div>
                <div class="main-menu">
                    <div class="menu">
                        <ul>
    ...
    <div class="banner banner--six padding-tb" id="home">
        <div class="container">
                    ...
                    <div class="col-lg-7 col-12 wow fadeInUp" data-wow-delay=".5s">
                        <div class="banner__content">
                            ...
                            <div class="banner__groupbtn">
                                ...
                                <a href="mailto:arketing@raiexpedition.co.id" class="lab-btn bg-title"><i class="icofont-phone"></i>Email</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="treatment padding-tb" id="ciri">
        <div class="container">
            ...
            <div class="section__wrapper">
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-5 col-12 wow fadeInUp" data-wow-delay=".5s">
                        <div class="treatment__content">
                            <div class="d-flex align-items-start treatment__left">
                                <div class="nav flex-column nav-pills treatment__tablists" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <!--<div class="testimonial testimonial--two testimonial--five padding-tb bg-home6" id="testimonial">
        <div class="container">
            ...
            <div class="section__wrapper">
                <div class="testimonial__slidertwo overflow-hidden wow fadeInUp" data-wow-delay=".5s">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial__item">
                                <div class="testimonial__inner">
                                    <div class="testimonial__thumb">
                                        <img src="assets/images/testimonial/03.jpg" alt="rajibraj">
                                    </div>
                                    <div class="testimonial__content">
                                        <img src="assets/images/testimonial/quote4.png" alt="rajibraj">
                                        <p>Continually productize compelling quality for packed with  elated productize compelling quality for packed in  with all elated Them Continually productize compelling  quality for packed with  elated productize compelling quality for packed in  with all elated Them Setting up to website and creating</p>
                                        <div class="testimonial__author">
                                            <div class="thumb">
                                                <img src="assets/images/testimonial/04.jpg" alt="rajibraj">
                                            </div>
                                            <div class="content">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-12">
                    <div class="appointment__content">
                        <div class="section__header wow fadeInUp" data-wow-delay=".5s">
                            <h3>Get the best consult <span>from your expert advisors</span></h3>
                            <p class="ms-0">Continually productize compelling quality for packed with  elated productize compelling quality for packed in  with all elated Them Setting up to website and creating pages.</p>
                        </div>
                        <div class="section__wrapper">
                            <ul>
                                <li class="wow fadeInUp" data-wow-delay=".5s">
                                    <div class="icon">
                                        <img src="assets/images/appointment/icon/03.jpg" alt="rajibraj">
                                    </div>
                                    <div class="text">
                                        <p>Tell With US</p>
                                ...
                                <li class="wow fadeInUp" data-wow-delay=".6s">
                                    <div class="icon">
                                        <img src="assets/images/appointment/icon/04.jpg" alt="rajibraj">
                                    </div>
                                    <div class="text">
                                        <p>Email drop Us</p>
                                        <p><b>Infohaldaa@gmail.com</b></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-6 col-12">
                    <div class="appointment__form wow fadeInUp" data-wow-delay=".5s">
                        <h4>Quick Online Consultancy Only on Few Minutes</h4>
                        <form action="#">
                            <input type="text" placeholder="Full Name">
                            <input type="email" placeholder="Email Address">
                            <select>
                                <option value="1">choose a adviser</option>
                            ...
                            <button type="submit" class="lab-btn bg-theme6">Appointment Now</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <!--<footer class="footer footer--four">
                            ...
                            <div class="footer__body wow fadeInUp" data-wow-delay=".5s">
                                <ul>
                                    <li>
                                        ...
                                        <div class="right">09AM - 8PM</div>
                                    </li>
                                    <li>
                                        <div class="left">Monday</div>
                                        <div class="right">10AM - 6PM</div>
                                    </li>
                                    <li>
                                        <div class="left">Tuesday</div>
                                        <div class="right">09AM - 7PM</div>
                                    </li>
                                    <li>
                                        <div class="left">Wednesday</div>
                                        <div class="right">03PM - 8PM</div>
                                    </li>
                                    <li>
        ...
        <div class="footer__bottom wow fadeInUp" data-wow-delay=".5s">
            <div class="container">
                <p>&copy; 2023 <a href="index.html">Haldaa</a> all Right Reserved by <a href="#" target="_blank">LabArtisan</a></p>
            </div>
        </div>
    </footer>-->
    <!-- ==========Footer Section Ends Here========== -->
  ...
  var mwb_whatsapp = function() {
    ...
    function P(t, e, a) {
      let n, o = !1,
        ...
        {
          description: c = "Short Desc"
        } = e,
        {
          welcomeMessage: l = "Hallo 👋<br><br> Apa yang bisa kami bantu?"
        } = e,
        {
